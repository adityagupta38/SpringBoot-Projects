...
public class User_Application_Role {
    ...
    private UUID user_application_role_uuid;
    ...
    private Application application;
	 ...
	 private Role role;
		...
		public UUID getUser_application_role_uuid() {
			return user_application_role_uuid;
		}

		public void setUser_application_role_uuid(UUID user_application_role_uuid) {
